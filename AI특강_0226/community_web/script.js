document.addEventListener('DOMContentLoaded', () => {
    ...
    // 애플리케이션 상태 변수
    let loggedInUser = JSON.parse(localStorage.getItem('loggedInUser')) || null; // 현재 로그인한 사용자 정보
    ...
    function loginUser(username, password) {
        ...
        if (user) {
            ...
            localStorage.setItem('loggedInUser', JSON.stringify(loggedInUser)); // 로컬 스토리지에 로그인 정보 저장
